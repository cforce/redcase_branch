h2. Redcase - Redmine Test managment plugin
...
1. Select Test case in the Tracker field,
2. Type in the test case name in the Subject field;
3. Describes the steps of test case in the Description field;
...
1. Right-click on any test suite in the tree;
2. Select New in the shortcut menu;
3. In the appeared dialog specify the name for the suite and click OK;
...
Optionally, you can provide a comment to the execution of the test case. It may be especially useful for results other than Passed. Click Save to save the execution result and the comment in the database. Before applying the reult, make sure that the correct version and environment is selected. After saving test result, the next test case in the tree will be selected automatically.
